...
const ChatTextarea = forwardRef<HTMLTextAreaElement, Props>(
  function ChatTextarea(
    ...
    // Callback ref that sets both the local ref and forwarded ref
    ...
    return (
      <div className="flex flex-col gap-1 flex-1">
        <textarea
          className={`flex flex-1 p-3 rounded outline-none resize-none bg-transparent leading-6 ${overflow}`}
